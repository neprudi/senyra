  ...
  return (
    <article className="soft-enter overflow-hidden rounded-[2rem] border border-white/80 bg-[rgba(255,253,249,0.82)] shadow-soft backdrop-blur-xl">
      <div className={cn(compact ? 'p-3' : 'p-4 sm:p-5')}>
        <ArtPanel palette={experience.palette} label={experience.fitLabel} className={cn('h-52', compact && 'h-44')} />
        ...
        <div className="mt-4 space-y-4">
          ...
          <div className="grid gap-3 rounded-[1.4rem] border border-cream-200/70 bg-cream-50/70 p-4 sm:grid-cols-2">
            <div className="space-y-1">
              <p className="text-[10px] font-semibold uppercase tracking-[0.24em] text-cream-700/65">Feeling it serves</p>
            ...
            <div className="space-y-1">
              <p className="text-[10px] font-semibold uppercase tracking-[0.24em] text-cream-700/65">Suggested dish</p>
              <p className="text-sm leading-6 text-cream-800/82">{experience.suggestedDish}</p>
            </div>
            <div className="space-y-1">
              <p className="text-[10px] font-semibold uppercase tracking-[0.24em] text-cream-700/65">Tonight's ritual</p>
          ...
          <div className="space-y-2 border-t border-cream-200/70 pt-3">
            <p className="text-[10px] font-semibold uppercase tracking-[0.24em] text-cream-700/65">Why this works for you</p>
          ...
          {isFeed ? (
            <div className="flex items-center justify-between border-t border-cream-200/70 pt-2">
              <button
                type="button"
                onClick={onOpen}
              ...
              <button
                ...
                className={cn(
                  ...
                  saved ? 'border-graphite/15 bg-graphite text-cream-50' : 'border-white/80 bg-white/80'
                )}
